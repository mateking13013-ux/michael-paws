...
export const puppies: Puppy[] = [
  ...
  {
    name: 'Lola',
    image: '/images/Lola new.jpeg',
    sex: 'Female',
    age: '10 Weeks',
    status: 'Available',
    price: 750,
    description: 'Lola is a striking dark dapple beauty with an enchanting personality. Her luxurious longer wavy coat with black and gray marbling and tan accents is absolutely breathtaking. She is gentle, loving, and loves to be pampered. Lola has a regal presence but is incredibly sweet and affectionate with her family',
    coat: 'Dark dapple puppy (black/gray marbling) with tan points and a lighter chest. Longer, wavy coat with feathery ears.'
  },
  {
    name: 'Chester',
    image: '/images/Chester new.jpeg',
    sex: 'Male',
    age: '10 Weeks',
    status: 'Available',
    price: 750,
    description: 'Chester is a confident little gentleman with a curious spirit and a heart full of love. His charming silver and gray dapple markings with black patches and smooth short coat make him irresistible. He loves to explore, play, and then curl up for naps. Chester has an outgoing personality and gets along well with everyone he meets',
  ...
  {
    name: 'Chloe',
    image: '/images/chloe-f.jpg',
    sex: 'Female',
    age: '10 Weeks',
    status: 'Available',
    price: 750,
    description: 'Chloe is a stunning cream blonde beauty with the softest fluffy coat. Her sweet temperament and love for cuddles make her an ideal companion. She is gentle, well-mannered, and loves being close to her family. Chloe would thrive in a loving home where she can be showered with attention',
    coat: 'Cream/blonde puppy with a lighter chest and floppy ears. Soft, silky short-to-medium coat and big dark eyes.'
  },
  {
    name: 'Badu',
    image: '/images/Badu-m.webp',
    sex: 'Male',
    age: '10 Weeks',
    status: 'Available',
    price: 750,
    description: 'Badu is a striking chocolate-brown dapple with mesmerizing eyes that will captivate your heart. His silky short-to-medium coat with unique marbled markings and tan points makes him truly one of a kind. He has a playful yet gentle nature and loves affection. Badu is searching for a family who will treasure his special beauty',
    coat: 'Chocolate-brown dapple (marbled) puppy with tan points on the eyebrows, muzzle, chest, and paws. Floppy ears and a silky short-to-medium coat.'
  },
  {
    name: 'Gus',
    image: '/images/gus-m.jpg',
    sex: 'Male',
    age: '10 Weeks',
    status: 'Available',
    price: 750,
  ...
  {
    name: 'Maisey',
    image: '/images/maisey-f.jpg',
    sex: 'Female',
    age: '10 Weeks',
    status: 'Available',
    price: 750,
    description: 'Maisey is a cute black and tan dapple with a smooth short coat and spunky personality. Her compact build and lively spirit make her absolutely adorable. She loves to play and explore but also enjoys quiet snuggle time. Maisey is looking for an active family to match her energy',
